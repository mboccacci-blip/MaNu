    ...
    <div className="fi">
      ...
      {(function(){
        ...
        {tier==="free" && <Cd glow="gold" style={{textAlign:"center",padding:"32px 24px"}}>
          ...
          <p style={{fontSize:14,color:"#64748b",lineHeight:1.6,maxWidth:380,margin:"0 auto 20px"}}>{lang==="en"?"Enter your email to unlock your exact Magic Number, year-by-year projections, and a personalized PDF report.":"Dejá tu email para desbloquear tu Magic Number exacto, proyecciones año por año e informe PDF personalizado."}</p>
