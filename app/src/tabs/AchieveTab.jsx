  ...
  return (
    <div className="fi">
      ...
      {magic.real>0&&ytr>0&&nEx>=0&&(mSav>0||nEx>0)?<>
        ...
        <div style={{padding:"12px 16px",borderRadius:10,background:"rgba(100,116,139,0.04)",border:"1px solid rgba(100,116,139,0.08)",fontSize:11,color:"#64748b",lineHeight:1.6,display:"flex",alignItems:"flex-start",gap:8,margin:"-4px 0 16px 0"}}><Icon name="info" size={14} weight="regular" style={{marginTop:1,flexShrink:0,color:"#94a3b8"}} /><span>{t('achieve.returnsDisclaimer')}</span></div>
        <Cd style={{padding:"20px"}}>
          <div style={{display:"flex",gap:16,flexWrap:"wrap"}}>
