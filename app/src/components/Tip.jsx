...
export default function Tip({ text }) {
  ...
  return (
    <span ref={ref} style={{ position: "relative", display: "inline-flex", alignItems: "center", marginLeft: 6 }}>
      ...
      {o && <span style={{ position: "absolute", bottom: "calc(100% + 10px)", left: "auto", right: 0, transform: "none", background: "#1e293b", color: "#e2e8f0", padding: "12px 16px", borderRadius: 12, fontSize: 13, maxWidth: "min(280px, 85vw)", width: "max-content", overflowWrap: "break-word", zIndex: 1000, lineHeight: 1.5, boxShadow: "0 8px 24px rgba(15,23,42,0.20)", fontFamily: "Outfit,sans-serif", border: "1px solid rgba(15,23,42,0.15)" }}>
        {text}
        <span style={{ position: "absolute", top: "100%", right: "8px", transform: "none", width: 0, height: 0, borderLeft: "8px solid transparent", borderRight: "8px solid transparent", borderTop: "8px solid #1e293b" }} />
      </span>}
    </span>
  );
}
